...
void PanelSetting::setupme()
{
    ...
    QLabel *labetR = new QLabel("Rotation:");
    ...
    fSpin_RX->setDecimals(4);
    fSpin_RY->setMinimum(-360);
    fSpin_RY->setMaximum(360);
    fSpin_RY->setDecimals(4);
    fSpin_RZ->setMinimum(-360);
    fSpin_RZ->setMaximum(360);
    fSpin_RZ->setDecimals(4);
    QLabel *labetT = new QLabel("Translation:");
